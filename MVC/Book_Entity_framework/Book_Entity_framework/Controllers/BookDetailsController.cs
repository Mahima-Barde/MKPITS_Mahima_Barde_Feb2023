...
using Book_Entity_framework.Models;

namespace Book_Entity_framework.Controllers
{
    public class BookDetailsController : Controller
    {
        private databookmodel db = new databookmodel();
        ...
        public ActionResult Create([Bind(Include = "Id,Bookname,Price")] BookDetail bookDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Bookname,Price")] BookDetail bookDetail)
        {
            if (ModelState.IsValid)
            {
